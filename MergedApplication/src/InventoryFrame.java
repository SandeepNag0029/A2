...
public class InventoryFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        culterBoxesRadioButton = new javax.swing.JRadioButton();
        ...
        culterBoxesRadioButton.setText("Culture Boxes");
        culterBoxesRadioButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                culterBoxesRadioButtonActionPerformed(evt);
            }
        });
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    .addGroup(layout.createSequentialGroup()
                                                        ...
                                                        .addComponent(culterBoxesRadioButton))
                                                    .addGroup(layout.createSequentialGroup()
                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                            .addComponent(processingRadioButton, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
    ...
    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        ...
        culterBoxesRadioButton.setSelected(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jRadioButton1.isSelected() && !jRadioButton2.isSelected() && !jRadioButton3.isSelected() 
                && !culterBoxesRadioButton.isSelected() && !genomicsRadioButton.isSelected() && !processingRadioButton.isSelected() && !referenceMaterialsRadioButton.isSelected())
        {
            fieldError = true;
            jTextArea1.append("\nMust select Tree, Seeds, Shrubs, cultureboxes, genomics, processing or referencematerials radio button.");
        ...
        if ( !fieldError )
        {
            try
            {
                ...
                String sourceURL;
                if(culterBoxesRadioButton.isSelected() || genomicsRadioButton.isSelected() || processingRadioButton.isSelected() || referenceMaterialsRadioButton.isSelected())
        ...
        if (!connectError && !fieldError )
        {
            try
            {
                ...
                if (jRadioButton3.isSelected())
                {
                 ...
                 // if cultureboxes are selected then insert inventory into seeds
                // table
                if (culterBoxesRadioButton.isSelected())
                {
                 ...
                 // if genomics are selected then insert inventory into seeds
                // table
                if (genomicsRadioButton.isSelected())
                {
                 ...
                 // if processing are selected then insert inventory into seeds
                // table
                if (processingRadioButton.isSelected())
                {
                 ...
                 // if referencematerials are selected then insert inventory into seeds
                // table
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
                ...
                || culterBoxesRadioButton.isSelected() || genomicsRadioButton.isSelected() || processingRadioButton.isSelected() || referenceMaterialsRadioButton.isSelected())
        {
            ...
            msgString = "Must select Tree, Seeds, Shrubs, cultureboxes, genomics, processing or referencematerials radio button.";
            jTextArea1.setText("\n"+msgString);
        }
        ...
        if (!connectError && !fieldError)
        {
            try
            {
                ...
                // ... here is the SQL for cultureboxes
                if (culterBoxesRadioButton.isSelected())
                {
                ...
                // ... here is the SQL for referencematerials
                if (referenceMaterialsRadioButton.isSelected())
                {
    ...
    private void culterBoxesRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_culterBoxesRadioButtonActionPerformed
        // TODO add your handling code here:
        jRadioButton1.setSelected(false);
        jRadioButton2.setSelected(false);
        jRadioButton3.setSelected(false);
        culterBoxesRadioButton.setSelected(true);
        genomicsRadioButton.setSelected(false);
        processingRadioButton.setSelected(false);
        referenceMaterialsRadioButton.setSelected(false);
    }//GEN-LAST:event_culterBoxesRadioButtonActionPerformed
    ...
    private void logoutButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logoutButtonActionPerformed
      ...
      //Update the Logout time in the DB  using the userName variable which has the username.
    ...
    */
    ...
    private javax.swing.JRadioButton culterBoxesRadioButton;
